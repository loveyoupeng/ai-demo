...
class TestGatedResidualsInit:
    ...
    def test_torch_gate_param_exists(self, ) -> None:
    ...
    def test_torch_gate_init_value(self, ) -> None:
    ...
    def test_torch_gate_has_grad_tracking(self, ) -> None:
    ...
    def test_numpy_gate_shapes(self, ) -> None:
...
class TestGatedResidualsLearn:
    ...
    def test_gates_change_after_training(self, ) -> None:
    ...
    def test_gate_controls_output(self, ) -> None:
...
class TestGatedResidualsStability:
    ...
    def test_gradient_norm_stable(self, ) -> None:
        ...
        for step in range(20):
            ...
            loss.backward()
            max_grad = max(
                p.grad.abs().max() for p in block.parameters() if p.grad is not None
            )
            assert max_grad < 500, (
                f"Gradient exploded after {step + 1} steps: {max_grad:.2f}"
            )
...
class TestPostNormNumPy:
    ...
    def test_gradient_flows_to_norm(self, ) -> None:
        ...
        assert not np.allclose(baseline, out_perturbed, atol=1e-3), (
            "Perturbing ln1 gamma should change output"
        )
...
class TestDropoutIdentity:
    ...
    def test_torch_inference_deterministic(self, ) -> None:
    ...
    def test_numpy_inference_deterministic(self, ) -> None:
...
class TestDropoutActive:
    ...
    def test_torch_train_mode_not_deterministic(self, ) -> None:
...
class TestCombinedArchitecture:
    ...
    def test_post_norm_gated_deterministic_inference(self, ) -> None:
    ...
    def test_post_norm_gated_grad_flow(self, ) -> None:
...
class TestAllThreeTogether:
    ...
    def test_train_loop_stability(self, ) -> None:
    ...
    def test_gates_open_during_training(self, ) -> None:
