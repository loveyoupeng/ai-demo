...
class TestMHANamingParity:
    ...
    def test_torch_mha_uses_linear_wrappers(self) -> None:
        ...
        mha_params = [k for k, _ in torch_model.named_parameters() if "mha" in k and "router" not in k]
    ...
    def test_triton_mha_uses_linear_wrappers(self) -> None:
        ...
        mha_params = [k for k, _ in triton_params.items() if "mha" in k and "router" not in k]
