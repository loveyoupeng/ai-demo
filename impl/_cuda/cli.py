"""CLI for inference with CUDA Model — runs on GPU only."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Generate text with CUDA LLM")
